...
public class CajeraThreadProductoMain {
    ...
    public static void main(String[] args) {
        ...
        Thread cajera1 = new Thread(new CajeraThreadProducto("Cajera 1", cliente1, tiempoInicial));
        Thread cajera2 = new Thread(new CajeraThreadProducto("Cajera 2", cliente2, tiempoInicial));
        Thread cajera3 = new Thread(new CajeraThreadProducto("Cajera 3", cliente3, tiempoInicial));
